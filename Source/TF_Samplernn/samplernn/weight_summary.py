...
def variable_summary(var, plot_bool=False, collections=None):
...
def keras_layer_summary(layer, plot_bool=False, collections=None):
    for var in layer.trainable_weights:
        variable_summary(var, plot_bool=plot_bool, collections=collections)
    return